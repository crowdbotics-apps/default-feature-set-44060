...
## Project Structure
    ...
    ├── default_feature_set_44060  # Django project configurations
...
1. Clone this repo and `cd default_feature_set_44060`
...
2. Clone this repo and `cd default_feature_set_44060`
