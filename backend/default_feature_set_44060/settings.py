"""
Django settings for default_feature_set_44060 project.
...
ROOT_URLCONF = 'default_feature_set_44060.urls'
...
WSGI_APPLICATION = 'default_feature_set_44060.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "default_feature_set_44060 API",
    "DESCRIPTION": "API documentation for default_feature_set_44060 App",
    "VERSION": "v1",
}
